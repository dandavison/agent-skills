...
Canvas Commons follows the [semver](https://semver.org/) versioning scheme.
Among other things, this means that any release with the same major version will
be backwards compatible. For example, an animation made using `v3.2.0` (In this
