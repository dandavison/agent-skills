...
The built-in exporter for Canvas Commons. It stores the rendered frames as a
...
The type of image file to which Canvas Commons will convert the frames. Current
options are PNG, JPEG, and WebP. Note that Canvas Commons depends on the
